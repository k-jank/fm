...
# Define a function to load and display the image from a file
...
if uploaded_file is None:
    # If no file is uploaded, display a dropdown menu
    images_dir = "att"  # Directory where your images are stored
